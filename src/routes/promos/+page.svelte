  ...
  <div class="grid no-space">
    ...
    <div class="s6">
      <div class="padding">
        ...
        <p>
          Для активации 15% - скидки необходимо зайти на
          <a
            class="link"
            href="https://tochka.com/showcase/LAIM/"
            target="_blank"
            rel="noopener noreferrer">
            сайт "ТОЧКА-ВИТРИНА"
          </a>
          и оформить заявку на товар компании "ЛАЙМ".
        </p>
        <p>
  ...
  <div class="grid no-space">
    ...
    <div class="s6">
      <div class="padding">
        ...
        <p>
          При заключении договора поставки на 2023 год компания ООО «ЛАЙМ»
          зафиксирует для вашей организации скидку «приоритет» в размере 30% на
          весь ассортимент, размещенный на сайте «ЛАЙМ» и сайтах-партнерах.
        </p>
        <p>
          ...
          запрос на получение договора поставки – и скидка «приоритет» активируется
        </p>
        <p>
          Предложение доступно всем категориям заказчиков, независимо от формы
          собственности.
        </p>
      </div>
    </div>
